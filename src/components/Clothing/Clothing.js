                      ...
                      {dataChoiceEvents.partyClothesSuit.initialPrice >
                        this.props.credit.available ? (
                          ...
                          <button
                            ...
                            onClick={(e) => this.props.payForClothingByCredit(e.target.value, 'partyClothing', 'creditSpends')}
                          >
                            Credit
                    </button>
                        )}{' '}
                      {dataChoiceEvents.partyClothesSuit.initialPrice >
                        this.props.cash ? (
                          ...
                          <button
                            className="button__1"
                            value={dataChoiceEvents.partyClothesSuit.initialPrice}
                            onClick={(e) => this.props.payForClothingByCash(e.target.value, 'partyClothing', 'cashSpends')}
                          >
                            Cash
                    </button>
                        )}
                        ...
                        {dataChoiceEvents.smartCasual.initialPrice >
                          this.props.credit.available ? (
                            ...
                            <button
                              ...
                              onClick={(e) => this.props.payForClothingByCredit(e.target.value, 'smartCasual', 'creditSpends')}
                            >
                              Credit
                      </button>
                          )}{' '}
                        {dataChoiceEvents.smartCasual.initialPrice >
                          this.props.cash ? (
                            ...
                            <button
                              className="button__2"
                              value={dataChoiceEvents.smartCasual.initialPrice}
                              onClick={(e) => this.props.payForClothingByCash(e.target.value, 'smartCasual', 'cashSpends')}
                            >
                              Cash
                      </button>
                          )}
                        ...
                        {dataChoiceEvents.casualClothes.initialPrice >
                          this.props.credit.available ? (
                            ...
                            <button
                              ...
                              onClick={(e) => this.props.payForClothingByCredit(e.target.value, 'casualClothing', 'creditSpends')}
                            >
                              Credit
                      </button>
                          )}{' '}
                        {dataChoiceEvents.casualClothes.initialPrice >
                          this.props.cash ? (
                            ...
                            <button
                              className="button__3"
                              value={dataChoiceEvents.casualClothes.initialPrice}
                              onClick={(e) => this.props.payForClothingByCash(e.target.value, 'casualClothing', 'cashSpends')}
                            >
                              Cash
                      </button>
                          )}
