                      ...
                      {dataChoiceEvents.careerProgression.initialPrice >
                        this.props.credit.available ? (
                          ...
                          <button
                            ...
                            onClick={(e) => this.props.payForCourseByCredit(e.target.value, 'course', 'creditSpends')}
                          >
                            Credit
                    </button>
                        )}{' '}
                      {dataChoiceEvents.careerProgression.initialPrice >
                        this.props.cash ? (
                          ...
                          <button
                            ...
                            onClick={(e) => this.props.payForCourseByCash(e.target.value, 'course', 'cashSpends')}
                          >
                            Cash
                    </button>
                        )}
                        ...
                        {dataChoiceEvents.holiday.initialPrice >
                          this.props.credit.available ? (
                            ...
                            <button
                              ...
                              onClick={(e) => this.props.payForHolidayByCredit(e.target.value, 'holiday', 'creditSpends')}
                            >
                              Credit
                      </button>
                          )}{' '}
                        {dataChoiceEvents.holiday.initialPrice > this.props.cash ? (
                          <div />
                            ...
                            <button
                              className="button__2"
                              value={dataChoiceEvents.holiday.initialPrice}
                              onClick={(e) => this.props.payForHolidayByCash(e.target.value, 'holiday', 'cashSpends')}
                            >
                              Cash
                      </button>
                          )}
